...
local states =
{
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            local time_for_active = ((inst:HasTag("player") and inst:HasTag("nocturn")) ~= TheWorld.state.isday)
    ...
    State{
        ...
        ontimeout = function(inst)
            ...
            if tent == nil or
                ...
                tent:HasTag("siestahut") ~= time_for_active or
